function DropManager(dropElement,callback,types){
        ...
        dropElement.addEventListener("drop",this.drop.bind(this));
        dropElement.addEventListener("dragover",this.onDragOver);    
        this.fileList = [];
...
DropManager.prototype.remove = function(){
...
console.log("DragDrop installed");
