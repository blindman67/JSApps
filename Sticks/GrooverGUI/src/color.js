    ...
    const color = (function(){
        ...
        function createControl(name,options){
            ...
            function setState(state = {}){
                ...
                if(state.gradient){
                    elements.container.style.backgroundImage = "-webkit-linear-gradient(top, #fff 0%, rgba(255, 255, 255, 0) 50%, rgba(0, 0, 0, 0) 50%, #000 100%), -webkit-linear-gradient(left, #7f7f7f 0%, rgba(127, 127, 127, 0) 100%)";
                    elements.container.style.backgroundColor = state.gradient;
