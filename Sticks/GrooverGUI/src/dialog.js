"use strict";
    ...
    const dialog = (function(){
        ...
        function createControl(name, options) {
            ...
            if(options.position.left === "center"){
                options.position.left = (GUI.window.width / 2) - (options.position.width / 2) | 0;
            }
            if (state) {
                state.top = undefined;
            ...
            var animations = {
                setPos(pos, data) {
                    ...
                    if (options.docked) {
                        ...
                        //op.top = options.dockedParent.options.position.top + options.dockedParent.options.position.height;
