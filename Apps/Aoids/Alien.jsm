...
import {buffers, BUFFER_POSITIONS} from "./Buffers.jsm";
...
import {Aoids} from "./Aoids.jsm";
import {buffers, BUFFER_POSITIONS} from "./buffers.jsm";
import {HullSimple} from "./Ship/Hull.jsm";
import {PowerSimple} from "./Ship/Power.jsm";
import {ThrusterSimple} from "./Ship/Thruster.jsm";
import {GunSimple} from "./Ship/Gun.jsm";
import {ShieldSimple} from "./Ship/Shield.jsm";
export {Alien};
const MOUNTS = {
    hull: HullSimple,
    power: PowerSimple,
